...
{
    public class RetailerMotivationRepository<TEntity> : IRepository<TEntity> where TEntity : class 
    {

        private readonly RetailerMotivationProgramEntities _context;

        public RetailerMotivationRepository(RetailerMotivationProgramEntities context)
        {
            _context = context;
        }
