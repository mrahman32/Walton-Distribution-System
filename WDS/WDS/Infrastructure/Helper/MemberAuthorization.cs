    ...
    public class MemberAuthorization:AuthorizeAttribute
    {
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            try
            {
                ...
                var permissions = (List<PermissionModel>)httpContext.Request.RequestContext.HttpContext.Session["permissions"];
        ...
        protected override void HandleUnauthorizedRequest(AuthorizationContext filterContext)
        {
            ...
            {
                var user = HttpContext.Current.Session["user"] as User;
                var permissions = (List<PermissionModel>)filterContext.RequestContext.HttpContext.Session["permissions"];
